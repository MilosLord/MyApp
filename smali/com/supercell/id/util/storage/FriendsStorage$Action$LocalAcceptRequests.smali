.class public final Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x19
    name = "LocalAcceptRequests"
.end annotation

.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nFriendsStorage.kt\nKotlin\n*S Kotlin\n*F\n+ 1 FriendsStorage.kt\ncom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,340:1\n704#2:341\n777#2,2:342\n704#2:344\n777#2,2:345\n*E\n*S KotlinDebug\n*F\n+ 1 FriendsStorage.kt\ncom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests\n*L\n73#1:341\n73#1,2:342\n73#1:344\n73#1,2:345\n*E\n"
.end annotation
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    iput-object p1, p0, Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;->accounts:Ljava/util/List;

    return-void
.end method

.method public static synthetic copy$default(Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;Ljava/util/List;ILjava/lang/Object;)Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;
    .locals 0
    ...
    iget-object p1, p0, Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;->accounts:Ljava/util/List;

    :cond_0
    invoke-virtual {p0, p1}, Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;->copy(Ljava/util/List;)Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;
...
.method public final component1()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;->accounts:Ljava/util/List;

    return-object v0
.end method

.method public final copy(Ljava/util/List;)Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public equals(Ljava/lang/Object;)Z
    ...
    instance-of v0, p1, Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;

    if-eqz v0, :cond_0

    check-cast p1, Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;

    iget-object v0, p0, Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;->accounts:Ljava/util/List;

    iget-object p1, p1, Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;->accounts:Ljava/util/List;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;->invoke(Lcom/supercell/id/util/Either;)Lcom/supercell/id/util/Either;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v1, "LocalAcceptRequests(accounts="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lcom/supercell/id/util/storage/FriendsStorage$Action$LocalAcceptRequests;->accounts:Ljava/util/List;
